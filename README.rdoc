== How to get set up:
    ...
    $ git clone git@github.com:rpearce/oh_you_sassy-ConvergeSE.git
    $ cd oh_you_sassy-ConvergeSE
    $ gem install bundler
    $ bundle install
    $ ruby app.rb
...
== Resources
One-click Ruby Installer (Windows)
...
SASS vs LESS graphical comparison
